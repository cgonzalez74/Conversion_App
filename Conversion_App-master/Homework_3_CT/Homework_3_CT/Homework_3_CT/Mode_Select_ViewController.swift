...
class Mode_Select_ViewController: UIViewController {
    ...
    @IBAction func savePressed(_ sender: UIBarButtonItem) {
        if let del = self.delegate{
            ...
            if(ViewController.ModeSelect.mode == "Length"){
    ...
    override func viewDidLoad() {
       ...
       // var modeString: String
        ...
        if(ViewController.ModeSelect.mode == "Length"){
            ...
            From_Output.text = fromPickerData[0]
            To_Output.text = fromPickerData[0]
        }
        else{
    ...
    override func viewWillDisappear(_ animated: Bool) {
        ...
        if let d = self.delegate {
            ...
            if(ViewController.ModeSelect.mode == "Length"){
                ...
                d.settingsChanged(fromUnits: from_val_v, toUnits: to_val_v)
            }
